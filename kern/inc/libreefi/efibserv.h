...
typedef EFI_STATUS(EFIAPI* EFI_ALLOCATE_PAGES)(IN EFI_ALLOCATE_TYPE Type,
	...
	INOUT EFI_PHYSICAL_ADDRESS* Memory);
typedef EFI_STATUS(EFIAPI* EFI_FREE_PAGES)(
	IN EFI_PHYSICAL_ADDRESS Memory, IN UINTN Pages);
typedef EFI_STATUS(EFIAPI* EFI_GET_MEMORY_MAP)(INOUT UINTN* MemoryMapSize,
	INOUT EFI_MEMORY_DESCRIPTOR* MemoryMap, OUT UINTN* MapKey,
...
typedef EFI_STATUS(EFIAPI* EFI_INSTALL_PROTOCOL_INTERFACE)(
	INOUT EFI_HANDLE* Handle, IN EFI_GUID* Protocol,
	IN EFI_INTERFACE_TYPE InterfaceType, IN VOID* Interface);
typedef EFI_STATUS(EFIAPI* EFI_REINSTALL_PROTOCOL_INTERFACE)(
	INOUT EFI_HANDLE* Handle, IN EFI_GUID* Protocol, IN VOID* OldInterface,
	IN VOID* NewInterface);
typedef EFI_STATUS(EFIAPI* EFI_UNINSTALL_PROTOCOL_INTERFACE)(
	INOUT EFI_HANDLE* Handle, IN EFI_GUID* Protocol, IN VOID* Interface);
...
typedef EFI_STATUS(EFIAPI* EFI_LOCATE_HANDLE)(
	IN EFI_LOCATE_SEARCH_TYPE SearchType, INOPT EFI_GUID* Protocol,
	INOPT VOID* SearchKey, INOUT UINTN* BufferSize, OUT EFI_HANDLE* Buffer);
typedef EFI_STATUS(EFIAPI* EFI_LOCATE_DEVICE_PATH)(IN EFI_GUID* Protocol,
	INOUT EFI_DEVICE_PATH_PROTOCOL** DevicePath, OUT EFI_HANDLE* Device);
typedef EFI_STATUS(EFIAPI* EFI_INSTALL_CONFIGURATION_TABLE)(
	IN EFI_GUID* Guid, IN VOID* Table);
typedef EFI_STATUS(EFIAPI* EFI_IMAGE_LOAD)(IN BOOLEAN BootPolicy,
	IN EFI_HANDLE ParentImageHandle,
	IN EFI_DEVICE_PATH_PROTOCOL* DevicePath, INOPT VOID* SourceBuffer,
...
typedef EFI_STATUS(EFIAPI* EFI_LOCATE_PROTOCOL)(
	IN EFI_GUID* Protocol, INOPT VOID* Registration, OUT VOID** Interface);
typedef EFI_STATUS(EFIAPI* EFI_OPEN_PROTOCOL)(IN EFI_HANDLE Handle,
	IN EFI_GUID* Protocol, OUT VOID** Interface OPTIONAL,
...
typedef EFI_STATUS(EFIAPI* EFI_CLOSE_PROTOCOL)(IN EFI_HANDLE Handle,
	IN EFI_GUID* Protocol, IN EFI_HANDLE AgentHandle,
...
typedef EFI_STATUS(EFIAPI* EFI_SET_WATCHDOG_TIMER)(IN UINTN Timeout,
	IN UINT64 WatchdogCode, IN UINTN DataSize, INOPT CHAR16* WatchdogData);
typedef EFI_STATUS(EFIAPI* EFI_CONNECT_CONTROLLER)(
	IN EFI_HANDLE ControllerHandle, INOPT EFI_HANDLE* DriverImageHandle,
	INOPT EFI_DEVICE_PATH_PROTOCOL* RemainingDevicePath,
	IN BOOLEAN Recursive);
typedef EFI_STATUS(EFIAPI* EFI_DISCONNECT_CONTROLLER)(
	IN EFI_HANDLE ControllerHandle, INOPT EFI_HANDLE DriverImageHandle,
	INOPT EFI_HANDLE ChildHandle);
typedef EFI_STATUS(EFIAPI* EFI_PROTOCOLS_PER_HANDLE)(IN EFI_HANDLE Handle,
	OUT EFI_GUID*** ProtocolBuffer, OUT UINTN* ProtocolBufferCount);
typedef EFI_STATUS(EFIAPI* EFI_LOCATE_HANDLE_BUFFER)(
	IN EFI_LOCATE_SEARCH_TYPE SearchType, INOPT EFI_GUID* Protocol,
	INOPT VOID* SearchKey, INOUT UINTN* NoHandles, OUT EFI_HANDLE** Buffer);
typedef EFI_STATUS(EFIAPI* EFI_INSTALL_MULTIPLE_PROTOCOL_INTERFACES)(
	INOUT EFI_HANDLE* Handle, ...);
...
typedef EFI_STATUS(EFIAPI* EFI_CREATE_EVENT_EX)(UINT32 Type, EFI_TPL NotifyTpl,
	...
	CONST EFI_GUID* EventGuid, EFI_EVENT* Event);
