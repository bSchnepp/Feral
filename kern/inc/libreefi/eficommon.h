...
// I don't think I should bother with gnu-efi compatibility (since clang can
// make pe-coff anyway, so i don't need to borrow linker scripts and all)
...
// Needed for simple text output protocol... (no, this isn't a typo, they're the
// same.)
