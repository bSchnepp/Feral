...
#include <feral/stdtypes.h>
	...
	{
		WSTRING Name;
		UINT64 UserID;// Up to 2^64 user accounts. Should be plenty for
			      // the overwhelming majority of all use cases.
		WSTRING Home;// typically A:/Users/<NAME>, but could also be
			     // under a parent's home.
		FERALTIME* CreationDate;
		FERALTIME* ExpirationDate;// If null, does not ever expire.

		BOOLEAN UsesPassword;
		BOOLEAN SystemAccount;// Is this account for a service? (ie,
				      // some daemon like a port of PulseAudio
				      // or something)
