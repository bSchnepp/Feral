...
#ifndef NDEBUG
VOID WpFunctionCallback(WpDebugReportCallbackFlags flags,
	WpDebugReportComType objType, uint64_t hObj, int32_t code,
	const char* ssName, const char* message, void* userData)
{
